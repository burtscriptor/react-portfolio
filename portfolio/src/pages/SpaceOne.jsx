      ...
      <div className="spaceOneContent">
        ...
        <div className="spaceOneTextItem">
          <div className="proHeader">
            <h3>ISS Locator</h3>
            <a
              href="https://github.com/burtscriptor/international-space-station-locator"
              target="_blank"
            ...
            <a
              href="https://space-station-locator-90bf1b592e8e.herokuapp.com/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="spaceText">
            <p>
              The ISS orbits the Earth every 90 minutes. Watch it travel across
              the globe. The location of the ISS is displayed on an interactive
              Google React Map and updates every seven seconds.
            </p>
            <p>What's next? Optimize memory usage.</p>
          </div>
